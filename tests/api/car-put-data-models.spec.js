...
test.describe("Test PUT Cars request - data models", () => {
    let client
    ...
    test("should modify car (PUT method) - data models", async () => {
    ...
    test("should throw error message with non authorized car (PUT method) - data models", async () => {
    ...
    test("should throw error message with invalid id (PUT method) - data models", async () => {
    ...
    test("should throw error message with invalid response body (PUT method) - data models", async () => {
