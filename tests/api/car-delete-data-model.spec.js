...
test.describe("Test DELETE request Cars - data models ", () => {
    let client
    let cars
    ...
    test("should delete car by id (DELETE method) - data models", async () => {
    ...
    test("should throw error message if user not authorized (DELETE method) - data models", async () => {
    ...
    test("should throw error message with invalid id (DELETE method) - data models", async () => {
